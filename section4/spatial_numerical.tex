...
\begin{cases}
\projectorSpatialArg{n}(\approxstateDiscreteArg{\indexMapper(n,i)})  & n = 2,\ldots,\nslabs,  \\
...
\end{cases}
\end{equation}
where $\projectorSpatialArg{n} : \RR{\fomdim} \rightarrow \trialspaceArg{n}$ is the $\elltwo$-orthogonal projector and is defined as 
