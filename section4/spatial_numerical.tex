...
denotes the time step, $\lmsWidthArg{n}{i}$ with $\lmsWidthArg{1}{1} = 1$ denotes the number of time steps employed by the scheme at the $i$th time instance over the $n$th window  and
