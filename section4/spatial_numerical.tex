...
\KTC{is this a
spectral method, or the spectral method? clarify} \EP{I don't understand what you mean. What is ``the" spectral method} 
...
\EP{These should be strictly increasing}
%\KTC{use cdots, not
...
\genCollocMatArg{n}{1},\ldots,\genCollocMatArg{n}{\nstepsArg{n}} 
 = \underset{\genCollocMatyArg{}{1},\ldots,\genCollocMatyArg{}{\nstepsArg{n}} }{\text{argmin } }
\objectiveArgC{n} (\basisspaceArg{n} \genCollocMatyArg{}{1} + \stateInterceptMat,\ldots,\basisspaceArg{n} \genCollocMatyArg{}{\nstepsArg{n}} + \stateInterceptMat) \qquad \text{ for } n = 1,2,...,\nslabs,
\end{equation*}
...
\genCollocMatArg{n-1}{\nstepsArg{n-1}}\collocBasisArg{n-1}{\nstepsArg{n-1}}(\timeWindowArg{n-1}{\nstepsArg{n-1}}) & n = 2,\ldots,\nslabs, \; i=1  \\
\basisspaceTArg{n} (\approxstateIC - \stateIntercept)& n=1, \;  i=1,
\end{cases}
\end{equation*}
...
guess for costate}\\ 
$\genstateArgnt{n}_1 \solveAlgo \basisspaceTArg{n} \stweightingMatArg{n}
\basisspaceArg{n} \genstateDotArgnt{n}_1  -  \basisspaceTArg{n} \stweightingMatArg{n}
...
\frac{d}{dt} \adjoint^n  + \basisspaceTArg{n} \bigg[\frac{\partial \velocity}{\partial \stateyDiscrete}(\basisspaceArg{n} \genstate^n_i + \stateIntercept,t) \bigg]^T \stweightingMatArg{n} \basisspaceArg{n} [\massArg{n}]^{-1} \adjoint^n = \\ -\bigg[\basisspaceTArg{n} \bigg[ \frac{\partial \velocity}{\partial \stateyDiscrete} ( \basisspaceArg{n} \genstate^n_i + \stateInterceptArg{n},t) \bigg]^T \stweightingMatArg{n} \bigg( \mathbf{I} -   \basisspace [\massArg{n}]^{-1} \basisspaceTArg{n} \bigg)  \stweightingMatArg{n} \bigg( \basisspaceArg{n} \dot{\genstate}_i^n   -   \velocity( \basisspaceArg{n} \genstate_i^n  +\stateInterceptArg{n},t) \bigg) \bigg] 
\end{multline*} }
...
\uIf{ $\objectiveArg{n}({\genstate_i^n}) \le \objectiveArg{n}({\genstate_{i-1}^n})$}
{
