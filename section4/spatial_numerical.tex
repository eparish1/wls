...
reducing this computational burden exist; Jacobian-free Newton--Krylov
	...
	reduce the wall time. While we leave a detailed investigation of these additional, potentially
	more efficient, solution algorithms as a topic of future work, we briefly examine the use of frozen Jacobians in Section~\ref{sec:swe} and Appendix~\ref{appendix:gnupdate}. 
\end{remark}
\begin{algorithm}
