...
``indirectly". A variety of both discretization/solution \KTC{why are these
lumped together? Could we just say ``discretization'', ``solution'', or
``discretization and solutin''?} techniques are possible
