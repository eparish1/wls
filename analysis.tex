...
\item \textbf{A4:} The FOM solution at the start of each time window lies
...
Leveraging the residual-minimization property of \methodAcronym\ and noting
	...
	\stateFOMSolArgt{n}{\timeStartArg{n}}$ by Assumption A4, we have 
...
\end{proof}
\begin{corollary}
	For the case of one time window $\DeltaSlabArg{1} = T$, then under Assumptions A3--A4  
