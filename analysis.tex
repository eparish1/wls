...
\item \textbf{A3:} The integrated residual is inverse Lipshitz continuous over
...
\EP{Changes here}
Defining $\errorStarArg{n} = \genstateROMSolArg{n} - \genstateROMStarSolArg{n}$, $n=1,\ldots,\nslabs$, where $\genstateROMStarSolArg{n}$ are the generalized coordinates of $\stateROMStarSolArg{n}$ (i.e., $\stateROMStarSolArgt{n}{t} = \basisspaceArg{n} \genstateROMStarSolArgt{n}{t} + \stateInterceptArg{n}$), a differential equation for the difference is given by
...
Employing assumptions A1-A2 yields the bound on the dynamic
