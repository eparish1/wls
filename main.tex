...
where $\integrand: \RR{M}  \times \RR{M}  \times[a,b] \rightarrow  \RRplus$
	...
	$\statez(a) = \statez_a$. \KTC{This previous sentence isn't correct. The
	...
	evaluated at the time-dependent function and its derivative..}\EP{ Check this, I think this is more precise now.} 
...
\statez(a) = \statez_a, \qquad \bigg[ \frac{\partial \integrand}{\partial \stateyDotDiscrete} \big(\statez(b),\statezDot(b),b \big) \bigg]^T = \bz.
\end{gather}
