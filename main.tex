...
of existing model reduction approaches, as particular instances of
  the methodology associate with Galerkin,
	...
	approach can yield more accurate and physically relevant solutions \KTC{What
	does `physically relevant' mean? This is imprecise.} than
...
\KTC{HERE, COFFEE BREAK}
Residual minimization methods in model reduction comprise 
