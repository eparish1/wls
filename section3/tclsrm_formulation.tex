...
%\KTC{I removed repeated equations here and just referred to their previous
%definitions. This will cut down on the text.}
%\begin{equation*}
...
%\end{align*} 
%subject to the boundary conditions~\eqref{eq:lspg_bcs1}--\eqref{eq:lspg_bcs}. 
