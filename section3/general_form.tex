...
%\end{equation}
where 
$\mathbb{P}^n (\stateyDiscrete) = XXX$ \KTC{EP TODO. Not trivila because
haven't introduced how you're going to use a \spatialAcronym\ subspace in this
context yet.} for \spatialAcronym\ subspaces
and
