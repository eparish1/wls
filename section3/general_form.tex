...
\caption{Partitioning of the time
	domain into time windows. \KTC{Improve this by making the time interval
	finite (i.e., $[0,T]$) and introduce a partitioning. You should also match the font size with the rest of
	the text. See Fig 1 of our paper ``Data-driven time parallelism via
...
$$ 
\KTC{This above doesn't make sense.}
