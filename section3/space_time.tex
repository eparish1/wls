...
$\stbasisArgnt{n} \in \RR{\fomdim \times
\stdimArg{n}}\otimes\timeSpaceArg{n}$; as the reader I think that
$\stbasisArgnt{n}$ can take on all temporal functions.} \KTC{I'm not
understanding why this is confusing. We previously said that a time dependent
$n$-vector is $\RR{n}\otimes \timeSpaceArg{n}$. This is the same exact thing
except for a time-dependent matrix.}
