...
\newcommand{\nskip}{N_{\text{skip}}}
\newcommand{\parameter}{\mu}
\newcommand{\spatialvar}{\mathsf{x}_1}
\newcommand{\spatialvarTwo}{\mathsf{x}_2}
\newcommand{\physDomain}{\Omega}
\newcommand{\parameterdomain}{\mathcal{D}}
\newcommand{\params}{\boldsymbol \mu}
\newcommand{\podIP}{\mathbf{P}}
\newcommand{\spacetimeWord}{state--time}
\newcommand{\spatialWord}{state}
\newcommand{\stateWord}{state}
...
\newcommand{\errorProject}{\tilde{\error}}
\newcommand{\errorProjectArg}[1]{\errorProject^{#1}}
\newcommand{\errorProjectArgt}[2]{\errorProject^{#1}(#2)}
...
\newcommand{\approxstateLR}{\approxstateDiscrete_{\text{lr}}} 
\newcommand{\approxstateLRIntercept}{\approxstateDiscrete_{\text{lr}_{\text{intercept}}}} 
...
\newcommand{\stateFOMDiscreteParamArg}[2]{\stateFOMDiscrete(#2)^{#1}}
