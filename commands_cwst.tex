...
\newcommand{\spatialIC}{\basisspaceTArg{n}(\basisspaceArg{n-1} \genstate^{n-1}(\timeEndArg{n-1} )  - \stateInterceptArg{n} )}
...
\newcommand{\genstateIC}{ \basisspaceTArg{n}( \stateFOMIC - \stateInterceptArg{1}) }
